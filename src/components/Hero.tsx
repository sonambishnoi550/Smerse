...
const Hero = () => {
  return (
    <div className='lg:bg-cover bg-no-repeat bg-center 2xl:min-h-fit relative md:pb-24 pb-10 bg-hero' style={{ backgroundImage: `url(./assets/images/webp/hero-bg.webp)` }}>
      <Header />
